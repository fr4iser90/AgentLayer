...
COMMANDS: dict[str, str] = {
    ...
    "workspace": "list workspaces, or /workspace create <name> [git url]",
    "bind": "/bind <id|name> — use that workspace here; /bind off to unbind",
    "index": "/index [full|code|docs] to (re)build, /index status to inspect",
