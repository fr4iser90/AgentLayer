...
One background thread; ticks call :func:`apps.backend.application.agent_runtime.use_cases.chat_completion.chat_completion` with
...
async def _run_one_tick() -> None:
    ...
    from apps.backend.infrastructure.agent_runtime.catalog_chat_llm_service import catalog_llm_body_extras
