...
from apps.backend.domain.delegation import artifact_handoff as handoff
...
handoff.register_delegate_enforcement_dependencies(_DelegateEnforcementDeps())
...
load_delegate_allowed_paths = handoff.load_delegate_allowed_paths
parse_requirement_value = handoff.parse_requirement_value
