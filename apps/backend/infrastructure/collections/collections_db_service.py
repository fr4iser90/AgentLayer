"""Infrastructure adapter for collection persistence ports."""

from __future__ import annotations

from apps.backend.domain.collections import attachments_db, db as collections_db
from apps.backend.infrastructure.persistence.postgres.collection_repository import PostgresCollectionPersistenceAdapter

_deps = PostgresCollectionPersistenceAdapter()
