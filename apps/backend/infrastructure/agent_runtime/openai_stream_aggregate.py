...
async def stream_chat_completions_aggregate(
    ...
    *,
    ...
    from apps.backend.infrastructure.agent_runtime.llm_concurrency import llm_slot_async
    ...
    while True:
        ...
        if last_http is not None:
            ...
            if st == 429 and lb == "provider_db":
                local_model = profile_default_model_id(outer_profile, _model_routing_settings())
