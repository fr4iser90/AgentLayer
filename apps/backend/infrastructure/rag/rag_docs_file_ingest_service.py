...
from apps.backend.domain.rag import docs_file_ingest as domain
from apps.backend.infrastructure.settings import operator_settings
from apps.backend.infrastructure.db import db
from apps.backend.infrastructure.rag.rag_ingest_service import ingest_markdown_paths as _registered_ingest
