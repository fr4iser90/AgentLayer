...
from apps.backend.infrastructure.providers.model_catalog_providers import build_model_provider_index
...
def invalidate_model_catalog_cache() -> None:
    ...
    _cache_at = 0.0
    _cache_index = {}
    from apps.backend.domain.model_routing.catalog_chat import invalidate_reachable_catalog_cache

    invalidate_reachable_catalog_cache()
    from apps.backend.infrastructure.providers.model_catalog_providers import invalidate_provider_specs_cache
