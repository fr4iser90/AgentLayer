...
def ensure_pgvector_embedding_dim(
    ...
    *,
    ...
    try:
        from apps.backend.infrastructure.settings.operator_settings import set_rag_docs_ingest_fingerprint
    ...
    try:
        from apps.backend.infrastructure.settings.operator_settings import _invalidate_pgvector_dim_cache
