...
class ChatAudioAttachmentDependencies(Protocol):
    ...
    def media_upload_dir(self) -> Path: ...
...
def ingest_chat_audio_attachments(
    ...
    *,
    ...
    for part in parts:
        ...
        try:
            _require_deps().write_bytes(_require_deps().media_upload_dir(), relpath, data)
            ...
            _require_deps().unlink_if_exists(_require_deps().media_upload_dir(), relpath)
