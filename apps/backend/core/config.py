...
AGENT_TOOLS_COUNT_CAP_STRONG = max(1, _env_int("AGENT_TOOLS_COUNT_CAP_STRONG", 25))
AGENT_TOOLS_COUNT_CAP_STANDARD = max(1, _env_int("AGENT_TOOLS_COUNT_CAP_STANDARD", 15))
AGENT_TOOLS_COUNT_CAP_WEAK = max(1, _env_int("AGENT_TOOLS_COUNT_CAP_WEAK", 10))
