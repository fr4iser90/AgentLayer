  ...
  return (
    <>
      <section className="mt-8 rounded-xl border border-surface-border bg-card p-5">
        ...
        <select
          id="hb-user"
          className="mt-1 w-full max-w-xl rounded-md border border-surface-border bg-field px-3 py-2 font-mono text-sm text-ink-primary"
        ...
        <p className="mt-4 rounded-md border border-white/10 bg-black/20 px-3 py-2 text-xs text-ink-muted">
