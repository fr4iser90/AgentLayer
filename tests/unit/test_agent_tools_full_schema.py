...
def test_tools_full_schema_default_is_true():
    # Real schemas are both more useful and, for large agents, cheaper than catalog stubs
    # (scripts/measure_tool_schema_cost.py: coding = 7.5k full vs 10.1k catalog tokens).
