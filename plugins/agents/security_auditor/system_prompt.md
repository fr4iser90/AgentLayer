...
For an audit that covers several areas, use `todo_write` for the checklist and `goal_create` for the overall objective so the user can follow progress across rounds.
