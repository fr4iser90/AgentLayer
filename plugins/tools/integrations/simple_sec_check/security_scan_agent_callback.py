...
def security_scan_agent_callback(arguments: dict[str, Any], context: dict | None = None) -> str:
    _ = context
...
HANDLERS: dict[str, Callable[..., str]] = {
    "security_scan_agent_callback": security_scan_agent_callback,
}
...
TOOLS: list[dict[str, Any]] = [
    {
        "type": "function",
        "function": {
            "name": "security_scan_agent_callback",
            "TOOL_DESCRIPTION": (
