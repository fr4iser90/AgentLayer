...
def security_scan_targets_list(arguments: dict[str, Any], context: dict | None = None) -> str:
    _ = context
...
HANDLERS: dict[str, Callable[..., str]] = {
    "security_scan_targets_list": security_scan_targets_list,
}
...
TOOLS: list[dict[str, Any]] = [
    {
        "type": "function",
        "function": {
            "name": "security_scan_targets_list",
