...
Output directory: ``plugins/tools/capabilities/browser/output/local-playwright-bundles/<stamp>/``.
"""
...
def _output_root() -> Path:
    root = Path(__file__).resolve().parent / "output" / "local-playwright-bundles"
