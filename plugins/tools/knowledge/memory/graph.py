...
def graph_node_add(arguments: dict[str, Any]) -> str:
...
def graph_edge_add(arguments: dict[str, Any]) -> str:
    try:
...
def graph_nodes_list(arguments: dict[str, Any]) -> str:
    wid = _parse_uuid(arguments.get("dashboard_id"))
    try:
...
def graph_propose(arguments: dict[str, Any]) -> str:
...
def graph_node_delete(arguments: dict[str, Any]) -> str:
    try:
