...
def patch_idea(arguments: dict[str, Any]) -> str:
...
def patch_scratchpad(arguments: dict[str, Any]) -> str:
...
HANDLERS: dict[str, Callable[[dict[str, Any]], str]] = {
    ...
    "read": read,
    "add_rows": add_rows,
    "patch_idea": patch_idea,
    "patch_scratchpad": patch_scratchpad,
}
