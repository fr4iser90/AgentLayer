"""Session-scoped todo list for the current build turn (in-memory, not dashboard tasks)."""
...
TOOL_DESCRIPTION = (
    "Create, update, and track a todo list for the current agent session (in-memory). "
    "Not dashboard task boards — use tasks.* tools for persisted todo dashboards. "
...
def todo(arguments: dict[str, Any]) -> str:
