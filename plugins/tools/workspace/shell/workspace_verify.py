...
TOOL_DESCRIPTION = (
    ...
    "Does not accept arbitrary commands from the model (unlike ``bash``). "
    "Same dangerous-pattern blocklist as ``bash``. Timeout from ``AGENT_WORKSPACE_VERIFY_TIMEOUT_SEC``. "
...
def workspace_verify(arguments: dict[str, Any], context: dict | None = None) -> str:
    ctx = context or {}
...
HANDLERS: dict[str, Callable[..., str]] = {
    "workspace_verify": cast(Callable[..., str], workspace_verify),
}
